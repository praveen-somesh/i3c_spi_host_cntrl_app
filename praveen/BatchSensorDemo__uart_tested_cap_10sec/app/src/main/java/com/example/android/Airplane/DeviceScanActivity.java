...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.putExtra(Android_Airplane_Activity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(Android_Airplane_Activity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning) {
